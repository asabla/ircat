...
func (s *Server) registerRoutes(api http.Handler) {
	...
	s.mux.HandleFunc("POST /dashboard/channels/{name}/register", s.requireSession(s.handleChannelRegister))
	s.mux.HandleFunc("POST /dashboard/channels/{name}/registration/update", s.requireSession(s.handleChannelRegistrationUpdate))
	s.mux.HandleFunc("POST /dashboard/channels/{name}/registration/delete", s.requireSession(s.handleChannelDrop))
	s.mux.HandleFunc("POST /dashboard/channels/{name}/access", s.requireSession(s.handleChannelAccessAdd))
	s.mux.HandleFunc("POST /dashboard/channels/{name}/access/{account_id}/delete", s.requireSession(s.handleChannelAccessRemove))
	...
	s.mux.HandleFunc("POST /dashboard/bots/validate", s.requireSession(s.handleBotValidatePost))
	s.mux.HandleFunc("POST /dashboard/bots/{id}/source", s.requireSession(s.handleBotSourcePost))
	s.mux.HandleFunc("GET /dashboard/bots/{id}/logs/stream", s.requireSession(s.handleBotLogsSSE))
	...
	s.mux.HandleFunc("GET /dashboard/accounts", s.requireSession(s.handleAccountsPage))
	s.mux.HandleFunc("POST /dashboard/accounts/create", s.requireSession(s.handleAccountCreate))
	s.mux.HandleFunc("GET /dashboard/accounts/{id}", s.requireSession(s.handleAccountDetailPage))
	s.mux.HandleFunc("POST /dashboard/accounts/{id}/delete", s.requireSession(s.handleAccountDelete))
	s.mux.HandleFunc("POST /dashboard/accounts/{id}/password", s.requireSession(s.handleAccountPasswordReset))
